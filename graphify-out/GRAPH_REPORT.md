...
## Corpus Check
- 66 files · ~36,008 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 433 nodes · 430 edges · 51 communities (43 shown, 8 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `434bb754`
...
1. `SPEC-007 — Authentication` - 14 edges
2. `SPEC-006 — Booking System` - 12 edges
3. `Stay Detail Page ([slug].vue)` - 12 edges
4. `GET /api/stays/[slug] handler` - 10 edges
5. `Wayrest Design System` - 9 edges
6. `SPEC-005 — Listing Detail Page` - 9 edges
7. `SPEC-004 — Homepage` - 9 edges
8. `Listing` - 9 edges
9. `SPEC-XXX — Component Name` - 7 edges
10. `Wayrest — Project Constitution` - 7 edges
...
Cohesion: 0.07
Nodes (29): copied, baseParams, confirmedBooking, globalStubs, mockNavigateTo, mockUseRoute, store, wrapper (+21 more)
...
Cohesion: 0.08
Nodes (23): AppHeader Updates, Auth.js v5 Configuration, AuthModal.vue, code:sql (-- Add user_id to bookings), code:typescript (// app/types/auth.ts), code:typescript (interface AuthState {), Components, Context (+15 more)
...
Cohesion: 0.15
Nodes (11): body, booking, config, REQUIRED_FIELDS, supabase, dbRow, mockEvent, mockGetServerSession (+3 more)

### Community 11 - "Search Bar Logic"
Cohesion: 0.15
Nodes (11): body, config, id, supabase, mockEvent, mockMaybeSingle, mockReadBody, mockSingle (+3 more)
...
Cohesion: 0.25
Nodes (6): config, supabase, mockBookings, mockEvent, mockGetServerSession, mockOrder

### Community 21 - "SEO Config"
Cohesion: 0.25
Nodes (6): authStore, { status }, fn, mockAbortNavigation, mockAuthStatus, mockOpenSignIn

### Community 22 - "Community 22"
Cohesion: 0.25
Nodes (5): passwordsMatch, pwErrs, strengthColors, strengthLabel, strengthLabels
...
Cohesion: 0.33
Nodes (4): globalStubs, store, wrapper, useAuthStore
...
Cohesion: 0.33
Nodes (4): mockAuthData, mockAuthStatus, mockSignOut, wrapper
...
Cohesion: 0.5
Nodes (3): PasswordValidationResult, result, validatePassword()

### Community 30 - "Community 30"
Cohesion: 0.4
Nodes (4): AuthModalState, AuthUser, RegisterForm, SignInForm
...
## Knowledge Gaps
- **259 isolated node(s):** `authOptions`, `config`, `supabase`, `listings`, `response` (+254 more)
...
- **Why does `Listing` connect `Search Bar Components` to `Listing Card & Grid`?**
...
- **What connects `authOptions`, `config`, `supabase` to the rest of the system?**
